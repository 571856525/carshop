...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" action="/index.php/Admin/Cate/bdel" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/index.php/Admin/Cate/add" class="btn btn-primary btn2"><i class="icon-font"></i>新增栏目</a>
                        <a id="batchDel" ><i class="icon-font" ></i><input  class="btn btn-primary btn2" type="submit" value="批量删除"></a>
                        <a id="updateOrd" href="/index.php/Admin/Cate/" class="btn btn-primary btn2"><i class="icon-font"></i>更新排序</a>
                    </div>
                </div>
