                        ...
                        <tbody><tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                <th>描述：</th>
                                <td>
                                 <input class="common-text" name="type" size="50" checked="checked" value="0" type="radio">列表
                                 <input class="common-text" name="type" size="50" value="1" type="radio">单页
                                 <input class="common-text" name="type" size="50" value="2" type="radio">留言
                                 <input class="common-text" name="type" size="50" value="3" type="radio">招聘
                                 </td>
                            </tr>
                            <tr>
